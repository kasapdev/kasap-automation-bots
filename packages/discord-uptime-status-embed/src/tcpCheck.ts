 ...
 *
 * Deliberately duplicated from the sibling `server-uptime-bot` package rather
 * than shared: light duplication of this small, stable primitive is preferred
 * here over pulling in a shared internal package for one function.
 */
